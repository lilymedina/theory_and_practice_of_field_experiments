...
Para escribir y guardar código reproducible se utiliza un cuarto panel, el Editor. Para esto, haga clic en el icono con una página en blanco con un signo más en la esquina superior izquierda de la interfaz de RStudio y seleccione `R Script`, como representado en la Figura B.5.
