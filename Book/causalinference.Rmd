...
- [Nota 51 de EGAP sobre políticas:  ¿pueden los sistemas de rendición de cuentas que parten desde la base mejorar los resultados en materia de salud?](https://egap.org/resource/does-information-technology-improve-public-service-delivery-lessons-from-uganda/)


- [Nota 69 de EGAP sobre políticas: ¿Sirven los sistemas enfocados en el ciudadano y que parten desde la base para ayudar a mejorar la prestación de servicios públicos?](https://egap.org/resource/brief-69-bottom-up-accountability-and-public-service-provision-in-brazil/)
