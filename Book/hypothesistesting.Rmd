...
- **Pruebas de hipótesis**.
     ...
     - Los $p$ valores y cómo interpretar los resultados de las pruebas de hipótesis.
...
A continuación presentamos las diapositivas con el contenido principal que cubrimos en nuestra clase sobre pruebas de hipótesis.  Usted puede usar directamente los archivos originales de las diapositivas o también puede copiarlos y editarlos localmente.
 ...
 - [Version de HTML](https://egap.github.io/learningdays-resources/Slides/hypothesistesting-slides.html)
...
### Guías de Métodos de EGAP
  ...
  - Guía de Métodos de EGAP [10 Cosas que debes saber sobre pruebas hipótesis](https://egap.org/resource/10-things-to-know-about-hypothesis-testing/)

  - Guía de Métodos de EGAP [10 Cosas que debes saber sobre comparaciones multiples](https://egap.org/resource/10-things-to-know-about-multiple-comparisons/)
